    ...
    [label, rgblabel, overlayimg, CC, labels] = segment_objects("None", "red", "intro to rob\bgfeb13.png", true, false, color_frame, depth_frame); % perform color segmentation (from last lab's pipeline) and return label for each identified object
    imshow(rgblabel);
